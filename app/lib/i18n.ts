...
const dict = {
  uz: {
    ...
    "landing.pricing.plan1Feature2": "Cheklangan qo'ng'iroq hajmi",
    "landing.pricing.plan1Feature3": "Email qo'llab-quvvatlash",
    "landing.pricing.plan2Name": "Biznes",
    "landing.pricing.plan2Badge": "Mashhur",
    "landing.pricing.plan2Desc": "O'rta jamoalar uchun",
    "landing.pricing.plan2Feature1": "Kengaytirilgan mezonlar",
    "landing.pricing.plan2Feature2": "Real-time statistika",
    "landing.pricing.plan2Feature3": "Ustuvor qo'llab-quvvatlash",
    "landing.pricing.plan3Name": "Korporativ",
    "landing.pricing.plan3Desc": "Katta tashkilotlar uchun",
  ...
  ru: {
    ...
    "landing.pricing.plan1Feature2": "Ограниченный объём звонков",
    "landing.pricing.plan1Feature3": "Поддержка по email",
    "landing.pricing.plan2Name": "Бизнес",
    "landing.pricing.plan2Badge": "Популярный",
    "landing.pricing.plan2Desc": "Для средних команд",
    "landing.pricing.plan2Feature1": "Расширенные критерии",
    "landing.pricing.plan2Feature2": "Статистика в реальном времени",
    "landing.pricing.plan2Feature3": "Приоритетная поддержка",
    "landing.pricing.plan3Name": "Корпоративный",
    "landing.pricing.plan3Desc": "Для крупных организаций",
  ...
  en: {
    ...
    "landing.pricing.plan1Feature2": "Limited call volume",
    "landing.pricing.plan1Feature3": "Email support",
    "landing.pricing.plan2Name": "Business",
    "landing.pricing.plan2Badge": "Popular",
    "landing.pricing.plan2Desc": "For mid-size teams",
    "landing.pricing.plan2Feature1": "Advanced criteria",
    "landing.pricing.plan2Feature2": "Real-time statistics",
    "landing.pricing.plan2Feature3": "Priority support",
    "landing.pricing.plan3Name": "Enterprise",
    "landing.pricing.plan3Desc": "For large organizations",
