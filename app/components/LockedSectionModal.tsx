...
export function LockedSectionModal({
  ...
  const { markUnlocked } = useSections();
    ...
    <Portal>
      <div className="fixed inset-0 z-100 flex items-center justify-center p-4">
        ...
        <div className="glass glow-ring relative w-full max-w-sm animate-slide-up rounded-2xl p-6">
          ...
          <h3 className="mt-4 text-center text-lg font-bold text-slate-800 dark:text-slate-100">Bu bo&apos;lim qulflangan</h3>
          <p className="mt-1.5 text-center text-sm text-slate-500 dark:text-slate-400">
            <span className="font-semibold text-slate-700 dark:text-slate-200">{sectionLabel}</span> bo&apos;limini ochish uchun
            administratoringiz bergan kodni kiriting.
          </p>
